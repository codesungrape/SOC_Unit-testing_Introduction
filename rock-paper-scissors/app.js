...
export function calculateRoundResult(playerMove, computerMove) {
  try {
    ...
    //check all conditions for payer wins
    if (
      ...
      return {
        outcome: WIN,
        message: `Player chose ${playerMove} and computer chose ${computerMove}. Player wins.`,
      };
    } else {
      return {
        outcome: WIN,
        message: `Computer chose ${computerMove} and player chose ${playerMove}. Computer wins.`,
      };
    }
  } catch (err) {
    throw new Error(
